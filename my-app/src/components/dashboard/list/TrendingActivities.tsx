...
export default function TrendingActivities() {
  ...
  const getTrainingData = () => {
    ...
    return Array.from({ length: 9 }, (_, i) => {
      const baseValue = 3000 + Math.floor(Math.random() * 3000);
      const growth = i * 400;
      return {
        name: ['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'Jul', 'Aug', 'Sep','Oct','Nov','Dec'][i],
        value: baseValue + growth + Math.floor(Math.random() * 500)
      };
    });
  };
    ...
    <div className="bg-white border rounded-lg shadow-sm">
      <div className="p-6">
        <div className="flex items-center justify-between mb-4">
          <div>
            <h3 className="text-lg font-semibold text-gray-900">Trend of training activities</h3>
            <p className="text-gray-500 text-sm mt-1">Monthly or quarterly</p>
          </div>
          <button 
        ...
        {/* Time Period Tabs */}
        <div className="flex justify-between gap-2 mb-6 overflow-x-auto border p-2 rounded">
        ...
        <ResponsiveContainer width="100%" height={250}>
          <AreaChart data={trainingData} margin={{ top: 10, right: 10, left: 0, bottom: 0 }}>
            <defs>
        ...
        <div className="flex justify-center gap-6 mt-4">
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm text-gray-600">Training Activities</span>
          </div>
        </div>
      </div>
