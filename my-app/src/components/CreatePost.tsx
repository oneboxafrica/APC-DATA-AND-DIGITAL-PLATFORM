    ...
    <div className="bg-white rounded-xl shadow mb-4  p-3">
      ...
      <div className="flex justify-around mt-3 text-sm">
        <button className="flex items-center gap-2 flex-1 justify-center py-2 hover:bg-gray-100 rounded-lg">
          ...
          <span className="font-medium hidden lg:block">Live video</span>
        </button>
        <button className="flex items-center gap-2 flex-1 justify-center py-2 hover:bg-gray-100 rounded-lg">
          <Image className="h-6 w-6 text-green-500" />
          <span className="font-medium hidden lg:block">Photo/video</span>
        </button>
        <button className="flex items-center gap-2 flex-1 justify-center py-2 hover:bg-gray-100 rounded-lg">
          <Smile className="h-6 w-6 text-yellow-500" />
          <span className="font-medium hidden lg:block">Feeling/activity</span>
        </button>
      </div>
    </div>
  );
